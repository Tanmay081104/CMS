                    ...
                    <div class="container my-3">
                        ...
                        <div class="row">
                                ...
                                <select class="form-select" id="class" name="class" style="width:100%;" required>
                                    ...
                                    <!-- <option value="12s">CSE</option>
                                    <option value="12s">BCE</option>
                                    <option value="12c">BEC </option>
                                    <option value="11s">BME</option>
 -->
                    ...
                    <div class="container my-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" aria-label="Default select example" id="state" name="state"
                                required>
                                <option selected disabled value="">--select--</option>
                                <option value="Hariyana">CHENNAI</option>
                                <option value="UP">AP</option>
                                <option value="Delhi">Delhi</option>
                                <option value="Panjab">Mumbai</option>
